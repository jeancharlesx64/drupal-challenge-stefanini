...
--
-- Table structure for table `node_revision__field_vacancies`
--

DROP TABLE IF EXISTS `node_revision__field_vacancies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node_revision__field_vacancies` (
  ...
  `field_vacancies_value` int NOT NULL,
  PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  KEY `bundle` (`bundle`),
  KEY `revision_id` (`revision_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Revision archive storage for node field field_vacancies.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node_revision__field_vacancies`
--

LOCK TABLES `node_revision__field_vacancies` WRITE;
/*!40000 ALTER TABLE `node_revision__field_vacancies` DISABLE KEYS */;
INSERT INTO `node_revision__field_vacancies` VALUES ('events',0,2,3,'en',0,50),('events',0,2,4,'en',0,0);
/*!40000 ALTER TABLE `node_revision__field_vacancies` ENABLE KEYS */;
UNLOCK TABLES;
