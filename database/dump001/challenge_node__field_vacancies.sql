...
--
-- Table structure for table `node__field_vacancies`
--

DROP TABLE IF EXISTS `node__field_vacancies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node__field_vacancies` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for node field field_vacancies.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node__field_vacancies`
--

LOCK TABLES `node__field_vacancies` WRITE;
/*!40000 ALTER TABLE `node__field_vacancies` DISABLE KEYS */;
INSERT INTO `node__field_vacancies` VALUES ('events',0,2,4,'en',0,0);
/*!40000 ALTER TABLE `node__field_vacancies` ENABLE KEYS */;
UNLOCK TABLES;
