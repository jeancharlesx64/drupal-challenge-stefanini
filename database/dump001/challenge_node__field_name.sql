...
--
-- Table structure for table `node__field_name`
--

DROP TABLE IF EXISTS `node__field_name`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for node field field_name.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node__field_name`
--

LOCK TABLES `node__field_name` WRITE;
/*!40000 ALTER TABLE `node__field_name` DISABLE KEYS */;
INSERT INTO `node__field_name` VALUES ('events',0,2,4,'en',0,'Happy Hour');
/*!40000 ALTER TABLE `node__field_name` ENABLE KEYS */;
UNLOCK TABLES;
