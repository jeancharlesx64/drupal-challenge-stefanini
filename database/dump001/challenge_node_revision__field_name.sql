...
--
-- Table structure for table `node_revision__field_name`
--

DROP TABLE IF EXISTS `node_revision__field_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node_revision__field_name` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Revision archive storage for node field field_name.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node_revision__field_name`
--

LOCK TABLES `node_revision__field_name` WRITE;
/*!40000 ALTER TABLE `node_revision__field_name` DISABLE KEYS */;
INSERT INTO `node_revision__field_name` VALUES ('events',0,2,2,'en',0,'Happy Hour'),('events',0,2,3,'en',0,'Happy Hour'),('events',0,2,4,'en',0,'Happy Hour');
/*!40000 ALTER TABLE `node_revision__field_name` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-02  9:35:19
